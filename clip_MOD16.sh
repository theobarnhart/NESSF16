...
for year in {2000,2001,2002,2003,2004,2005,2006,2007,2008,2009,2010,2011,2012,2013,2014}; do
	for month in {01,02,03,04,05,06,07,08,09,10,11,12}; do
			...
			gdalwarp -tr 0.0625 0.0625 -r near -t_srs '+proj=longlat +ellps=WGS84 +datum=WGS84 +no_defs' -cutline $shape -cl 'westernUS' -crop_to_cutline tmp.vrt MOD16A2_wUS_A${year}M${month}.clp.tiff
